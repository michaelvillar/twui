...
- (void)scrollRectToVisible:(CGRect)rect animated:(BOOL)animated
{
	...
	if(rect.origin.y < visible.origin.y) {
		...
		[self setContentOffset:CGPointMake(self.contentOffset.x, -rect.origin.y + visible.size.height - rect.size.height) animated:animated];
	} else if(rect.origin.x < visible.origin.x) {
    // scroll right
    [self setContentOffset:CGPointMake(-rect.origin.x, self.contentOffset.y) animated:animated];
  } else if(rect.origin.x + rect.size.width > visible.origin.x + visible.size.width) {
    // scroll right
    [self setContentOffset:CGPointMake(-rect.origin.x + visible.size.width - rect.size.width, self.contentOffset.y) animated:animated];
  }
